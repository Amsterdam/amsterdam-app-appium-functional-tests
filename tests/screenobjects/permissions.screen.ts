...
class PermissionsScreen extends Screen {
    ...
    get androidPermissionsButton() {
        const selector = 'new UiSelector().text("Permissions").className("android.widget.Textview")'
        return selector
    }

    get androidLocationPermissionsButton() {
        const selector = 'new UiSelector().text("Location").className("android.widget.Textview")'
        return selector
    }

    get androidAllowWhileUsingAppRadioButton() {
        const selector = 'new UiSelector().text("Allow only while using the app").className("android.widget.RadioButton")'
        return selector
    }

    get androidAllowOnlyThisTimeRadioButton() {
        const selector = 'new UiSelector().text("Ask every time").className("android.widget.RadioButton")'
        return selector
    }

    get androidAllowDontAllowRadioButton() {
        const selector = 'new UiSelector().text("Don\'t allow").className("android.widget.RadioButton")'
        return selector
    }
    ...
    get androidAllowOnlyThisTimeButton() {
        ...
        //return selector
        return helpers.createSelector("com.android.permissioncontroller:id/permission_allow_one_time_button")
    }


    get androidAllowDontAllowButton() {
        return helpers.createSelector("com.android.permissioncontroller:id/permission_deny_button")
    }
