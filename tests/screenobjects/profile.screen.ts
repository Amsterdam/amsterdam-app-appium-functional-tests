...
class ProfileScreen extends Screen {
  ...
  get addressSearchResultWeesperstraat113() {
    ...
    return helpers.createSelector(
      'AddressSearchResultadr-8cf66b905374f45aa16f692cd537d013Button',
    )
  }
  ...
  get addressSearchResultBalistraat1hg1() {
    ...
    return helpers.createSelector(
      'AddressSearchResultadr-99f4d1223f0f6b0c4a9086aa4c18f894Button',
    )
  }
  ...
  get addressLocationPrivacyInfoButton() {
    ...
    if (OS === 'iOS') {
      return $(
        `-ios predicate string: label == "Zo gebruiken wij uw locatie en adres"`,
      )
    }
    //Android:
    else {
      const selector =
        'new UiSelector().text("Zo gebruiken wij uw locatie en adres").className("android.view.View")'
  ...
  async addressSelector(adres: string) {
    ...
    //Android:
      ...
      return helpers.createContentSelector(adres)
    }
  }
