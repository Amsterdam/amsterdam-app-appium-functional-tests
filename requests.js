...
const wasteGuideUrlData = 'https://api.data.amsterdam.nl/v1/afvalwijzer/afvalwijzer/'
const wasteGuideUrlApp = 'https://api-waste-guide.app-amsterdam.nl/api/v1/search'
